    ...
    <div className={`${bgColor} pb-[45px]  lg:py-[115px]  lg:px-4`}>
      <div className="container mx-auto">
        ...
        >
          ...
          <div
            className={`flex-1 relative py-[30px] px-[46px] lg:p-[57px] before:absolute before:top-0 md:w-auto lg:w-[764px] before:bottom-0 before:${bgColor2} max-w-[calc(100%-400px)] ${
              image_position === "left"
                ? "before:left-0 before:right-[150px] before:mr-[-95px] before:md:mr-0 pr-0 lg:pr-[64px] "
                : "before:right-0 before:left-[210px] lg:pl-[64px] pl-0 before:ml-[-121px] before:md:ml-0"
            }`}
          >
            <div className="relative aspect-[640/455]">
            <Image
              src={image_src}
              alt=""
              // width={640}
              // height={455}
              className="relative lg:h-[455px]"
              fill
            />
