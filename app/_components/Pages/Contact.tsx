  ...
  return (
    <div>
      <HeroWithTitles
        ...
        max_width
      />
      <div className="container mx-auto mb-30 mt-30">
        <span className="block h-[5px] w-full bg-gray3" />
      </div>
      <div className="bg-white px-4 pb-140 pt-120">
      ...
      >
        <div className="flex max-w-[515px] flex-col text-black">
          <h2 className="text-5xl font-semibold">{data.MapTitle}</h2>
